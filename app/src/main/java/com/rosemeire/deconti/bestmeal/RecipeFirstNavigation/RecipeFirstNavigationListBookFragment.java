...
/* ************************************************************************************************/
/* *** Treat Fragment List Recipe: BOOK
/* ************************************************************************************************/
public class RecipeFirstNavigationListBookFragment extends Fragment {
    ...
    /* ********************************************************************************************/
    public RecipeFirstNavigationListBookFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_first_navigation_fragment_book_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeListModelsBook);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_LIST_BOOK_TOOLBAR);

        // ........................................... Get data from SQLite and update recycler view
        progressBar.setVisibility(View.VISIBLE);

        List<RecipeHeaderModel> list_book = RecipeDatabaseSQLiteTableHeader.RecipeHeaderGetListBook(getContext());

        recyclerView.setAdapter(new RecipeFirstNavigationListBookRecyclerAdapter(list_book, mListener, getContext()));
