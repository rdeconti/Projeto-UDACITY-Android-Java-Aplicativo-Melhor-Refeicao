...
import com.rosemeire.deconti.bestmeal.RecipeFirstNavigation.RecipeFirstNavigationListPrintedFragment.OnListFragmentInteractionListener;
...
/* *** Treat recycler view
/* ************************************************************************************************/
public class RecipeFirstNavigationListPrintedRecyclerAdapter extends RecyclerView.Adapter<RecipeFirstNavigationListPrintedRecyclerAdapter.ViewHolder> {
    ...
    /* ********************************************************************************************/
    RecipeFirstNavigationListPrintedRecyclerAdapter(List<RecipeHeaderModel> items, OnListFragmentInteractionListener listener, Context context) {
