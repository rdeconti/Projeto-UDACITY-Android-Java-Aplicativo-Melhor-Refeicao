...
/* ************************************************************************************************/
/* *** Treat Fragment List Recipe: SHARED
/* ************************************************************************************************/
public class RecipeFirstNavigationListSharedFragment extends Fragment {
    ...
    /* ********************************************************************************************/
    public RecipeFirstNavigationListSharedFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_first_navigation_fragment_shared_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeListModelsShared);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_LIST_SHARED_TOOLBAR);

        // ........................................... Get data from SQLite and update recycler view
        progressBar.setVisibility(View.VISIBLE);

        List<RecipeHeaderModel> list_shared = RecipeDatabaseSQLiteTableHeader.RecipeHeaderGetListShared(getContext());

        recyclerView.setAdapter(new RecipeFirstNavigationListSharedRecyclerAdapter(list_shared, mListener, getContext()));
