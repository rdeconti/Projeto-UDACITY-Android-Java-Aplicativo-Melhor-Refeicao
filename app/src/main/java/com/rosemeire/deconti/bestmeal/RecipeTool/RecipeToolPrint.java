...
/* *** RECIPE TOOL: PRINT
/* ************************************************************************************************/
public class RecipeToolPrint {

    public RecipeToolPrint(Context context) {

        sDesiredRecipeStatus = RECIPE_TREAT_PRINTED;
        ...
        Intent intent = new Intent(context, RecipeToolPrintActivity.class);
