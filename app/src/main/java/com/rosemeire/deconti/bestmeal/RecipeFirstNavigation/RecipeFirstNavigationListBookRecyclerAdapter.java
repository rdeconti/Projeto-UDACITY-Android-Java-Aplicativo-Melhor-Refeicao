...
import com.rosemeire.deconti.bestmeal.RecipeFirstNavigation.RecipeFirstNavigationListBookFragment.OnListFragmentInteractionListener;
...
/* *** Treat recycler view
/* ************************************************************************************************/
public class RecipeFirstNavigationListBookRecyclerAdapter extends RecyclerView.Adapter<RecipeFirstNavigationListBookRecyclerAdapter.ViewHolder> {
    ...
    /* ********************************************************************************************/
    RecipeFirstNavigationListBookRecyclerAdapter(List<RecipeHeaderModel> items, OnListFragmentInteractionListener listener, Context context) {
    ...
    private void getSQLiteUpdatedButtons() {
        ...
        ArrayList recipeStatuses = RecipeDatabaseFirebaseTableHeader.RecipeHeaderGetRecipeNumbers(mContext);
    ...
    private void obtainRecipePhoto(final ViewHolder holder) {
        ...
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child(PATH_RECIPES_1).child(sCurrentRecipePhoto);
