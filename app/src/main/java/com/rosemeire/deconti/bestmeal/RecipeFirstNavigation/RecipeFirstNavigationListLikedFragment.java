...
/* ************************************************************************************************/
/* *** Treat Fragment List Recipe: LIKED
/* ************************************************************************************************/
public class RecipeFirstNavigationListLikedFragment extends Fragment {
    ...
    /* ********************************************************************************************/
    public RecipeFirstNavigationListLikedFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_first_navigation_fragment_liked_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeListModelsLiked);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_LIST_LIKED_TOOLBAR);

        // ........................................... Get data from SQLite and update recycler view
        progressBar.setVisibility(View.VISIBLE);

        List<RecipeHeaderModel> list_liked = RecipeDatabaseSQLiteTableHeader.RecipeHeaderGetListLiked(getContext());

        recyclerView.setAdapter(new RecipeFirstNavigationListLikedRecyclerAdapter(list_liked, mListener, getContext()));
