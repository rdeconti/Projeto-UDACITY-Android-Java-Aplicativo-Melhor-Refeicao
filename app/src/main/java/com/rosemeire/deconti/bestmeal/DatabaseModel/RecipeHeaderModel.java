...
public class RecipeHeaderModel implements Parcelable {

    public static final Creator<RecipeHeaderModel>
            CREATOR = new Creator<RecipeHeaderModel>() {

        @Override
        public RecipeHeaderModel createFromParcel(Parcel in) {
            return new RecipeHeaderModel(in);
        }

        @Override
        public RecipeHeaderModel[] newArray(int size) {
            return new RecipeHeaderModel[size];
        }
    };
    ...
    public RecipeHeaderModel(Parcel in) {
