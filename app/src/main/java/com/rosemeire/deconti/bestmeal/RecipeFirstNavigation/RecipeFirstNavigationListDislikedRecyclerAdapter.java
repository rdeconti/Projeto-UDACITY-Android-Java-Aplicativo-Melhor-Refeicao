...
import com.rosemeire.deconti.bestmeal.RecipeFirstNavigation.RecipeFirstNavigationListDislikedFragment.OnListFragmentInteractionListener;
...
/* *** Treat recycler view
/* ************************************************************************************************/
public class RecipeFirstNavigationListDislikedRecyclerAdapter extends RecyclerView.Adapter<RecipeFirstNavigationListDislikedRecyclerAdapter.ViewHolder> {
    ...
    /* ********************************************************************************************/
    RecipeFirstNavigationListDislikedRecyclerAdapter(List<RecipeHeaderModel> items, OnListFragmentInteractionListener listener, Context context) {
