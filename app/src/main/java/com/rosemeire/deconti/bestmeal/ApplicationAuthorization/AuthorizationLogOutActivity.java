...
/* ************************************************************************************************/
/* *** TREAT AUTHORIZATION: CHANGE USER LOGOUT
/* ************************************************************************************************/
public class AuthorizationLogOutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.application_authorization_logout_activity);
        ...
        toolbar.setSubtitle(R.string.label_logout);
        ...
        button_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new SupportMessageToast(getApplicationContext(), getString(R.string.message_user_logout_success));
                startActivity(new Intent(getApplicationContext(), AuthorizationLogInActivity.class));
                progressBar.setVisibility(View.INVISIBLE);
                finish();
