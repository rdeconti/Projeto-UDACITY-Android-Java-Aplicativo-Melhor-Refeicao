...
/* ************************************************************************************************/
/* *** Treat Fragment List Recipe: BEST
/* ************************************************************************************************/
public class RecipeFirstNavigationListBestFragment extends Fragment {
    ...
    /* ********************************************************************************************/
    public RecipeFirstNavigationListBestFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_first_navigation_fragment_best_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeListModelsBest);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_LIST_BEST_TOOLBAR);
        ...
        if (!sReturnCode) {
            ...
            List<RecipeHeaderModel> list_best = RecipeDatabaseFirebaseTableHeader.RecipeHeaderListGetBest();

            recyclerView.setAdapter(new RecipeFirstNavigationListBestRecyclerAdapter(list_best, mListener, getContext()));
