package com.rosemeire.deconti.bestmeal.ApplicationTexts;
...
/* **** Treat Terms of Use
/* ********************************************************************************************** */
public class ApplicationTextTermsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.application_text_terms_and_conditions_activity);
        ...
        toolbar.setSubtitle(R.string.label_terms_of_use);
