...
/* ************************************************************************************************/
public class RecipeSecondNavigationStatisticsFragment extends Fragment {
    ...
    private List<RecipeStatisticsModel> list = new ArrayList<>();
    ...
    /* ********************************************************************************************/
    public RecipeSecondNavigationStatisticsFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_second_navigation_fragment_statistics_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeStatisticsModels);
        ...
        if (sGetDataFrom.equals(DATA_GET_FROM_FIREBASE)) {
            ...
            list = RecipeDatabaseFirebaseTableHeader.RecipeHeaderListGetStatistics();

        } else {

            list = RecipeDatabaseSQLiteTableHeader.RecipeHeaderGetStatistics(getContext());

        }

        recyclerView.setAdapter(new RecipeSecondNavigationStatisticsRecyclerAdapter(list, mListener, getContext()));
