...
import com.rosemeire.deconti.bestmeal.RecipeFirstNavigation.RecipeFirstNavigationListLikedFragment.OnListFragmentInteractionListener;
...
/* *** Treat recycler view
/* ************************************************************************************************/
public class RecipeFirstNavigationListLikedRecyclerAdapter extends RecyclerView.Adapter<RecipeFirstNavigationListLikedRecyclerAdapter.ViewHolder> {
    ...
    /* ********************************************************************************************/
    RecipeFirstNavigationListLikedRecyclerAdapter(List<RecipeHeaderModel> items, OnListFragmentInteractionListener listener, Context context) {
