...
/* ************************************************************************************************/
/* *** Treat Fragment Detail Recipe: COMMENTS
/* ************************************************************************************************/
public class RecipeSecondNavigationCommentsFragment extends Fragment {
    ...
    private List<RecipeCommentsModel> list = new ArrayList<>();
    ...
    /* ********************************************************************************************/
    public RecipeSecondNavigationCommentsFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_second_navigation_fragment_comments_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeCommentsModels);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_DETAIL_COMMENTS_TOOLBAR);
        ...
        if (sGetDataFrom.equals(DATA_GET_FROM_FIREBASE)) {
            ...
            list = RecipeDatabaseFirebaseTableComments.RecipeListDetailCommentsGetList();

        } else {

            list = RecipeDatabaseSQLiteTableComments.RecipeCommentsGetList(getContext());

        }

        recyclerView.setAdapter(new RecipeSecondNavigationCommentsRecyclerAdapter(list, mListener, getContext()));
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(RecipeCommentsModel item);
    }
}
