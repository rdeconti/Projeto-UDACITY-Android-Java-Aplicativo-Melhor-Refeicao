...
import com.rosemeire.deconti.bestmeal.RecipeFirstNavigation.RecipeFirstNavigationListReprovedFragment.OnListFragmentInteractionListener;
...
/* *** Treat recycler view
/* ************************************************************************************************/
public class RecipeFirstNavigationListReprovedRecyclerAdapter extends RecyclerView.Adapter<RecipeFirstNavigationListReprovedRecyclerAdapter.ViewHolder> {
    ...
    /* ********************************************************************************************/
    RecipeFirstNavigationListReprovedRecyclerAdapter(List<RecipeHeaderModel> items, OnListFragmentInteractionListener listener, Context context) {
