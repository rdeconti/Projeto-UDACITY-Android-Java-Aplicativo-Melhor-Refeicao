...
/* ************************************************************************************************/
/* *** Treat Fragment Detail Recipe: TIPS
/* ************************************************************************************************/
public class RecipeSecondNavigationTipsFragment extends Fragment {
    ...
    private List<RecipeTipsModel> list = new ArrayList<>();
    ...
    /* ********************************************************************************************/
    public RecipeSecondNavigationTipsFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_second_navigation_fragment_tips_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeTipsModels);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_DETAIL_TIPS_TOOLBAR);
        ...
        if (sGetDataFrom.equals(DATA_GET_FROM_FIREBASE)) {
            ...
            list = RecipeDatabaseFirebaseTableTips.RecipeListDetailTipsGetList();

        } else {

            list = RecipeDatabaseSQLiteTableTips.RecipeTipsGetList(getContext());

        }

        recyclerView.setAdapter(new RecipeSecondNavigationTipsRecyclerAdapter(list, mListener, getContext()));
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(RecipeTipsModel item);
    }
}
