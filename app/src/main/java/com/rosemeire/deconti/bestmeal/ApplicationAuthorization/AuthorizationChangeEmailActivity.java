...
/* ************************************************************************************************/
/* *** TREAT AUTHORIZATION: CHANGE USER EMAIL
/* ************************************************************************************************/
public class AuthorizationChangeEmailActivity extends AppCompatActivity {

    private ProgressBar progressBar;
    private EditText editText_old_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.application_authorization_change_email_activity);
        ...
        toolbar.setSubtitle(R.string.label_changeEmail);
        ...
        editText_old_email = findViewById(R.id.editText_old_email);
        ...
        button_change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String oldEmail = editText_old_email.getText().toString();
                String newEmail = editText_new_email.getText().toString();

                if (TextUtils.isEmpty(oldEmail)) {
                    new SupportMessageToast(getApplicationContext(), getString(R.string.message_user_changeEmail_old_empty));
                    return;
                }

                sReturnCode = SupportCheckEmail(oldEmail);
                if (!sReturnCode) {
                ...
                if (TextUtils.isEmpty(newEmail)) {
                    new SupportMessageToast(getApplicationContext(), getString(R.string.message_user_changeEmail_new_empty));
                    return;
                }

                sReturnCode = SupportCheckEmail(newEmail);
                if (!sReturnCode) {
                    new SupportMessageToast(getApplicationContext(), getString(R.string.message_user_email_invalid));
                    return;
                }
                ...
                if (newEmail.equals(oldEmail)) {
                    new SupportMessageToast(getApplicationContext(), getString(R.string.message_user_changeEmail_different));
                    return;
                }
                ...
                sFirebaseUser.updateEmail(newEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            new SupportMessageToast(getApplicationContext(), getString(R.string.message_user_changeEmail_success));
                            ...
                            new SupportMessageToast(getApplicationContext(), getString(R.string.message_user_changeEmail_failed));
