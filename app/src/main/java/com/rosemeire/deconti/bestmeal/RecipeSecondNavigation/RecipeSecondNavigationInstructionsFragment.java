...
/* ************************************************************************************************/
/* *** Treat Fragment Detail Recipe: INSTRUCTIONS
/* ************************************************************************************************/
public class RecipeSecondNavigationInstructionsFragment extends Fragment {
    ...
    private List<RecipeInstructionsModel> list = new ArrayList<>();
    ...
    /* ********************************************************************************************/
    public RecipeSecondNavigationInstructionsFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_second_navigation_fragment_instructions_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeInstructionsModels);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_DETAIL_INSTRUCTIONS_TOOLBAR);
        ...
        if (sGetDataFrom.equals(DATA_GET_FROM_FIREBASE)) {
            ...
            list = RecipeDatabaseFirebaseTableInstructions.RecipeListDetailInstructionsGetList();

        } else {

            list = RecipeDatabaseSQLiteTableInstructions.RecipeInstructionsGetList(getContext());

        }

        recyclerView.setAdapter(new RecipeSecondNavigationInstructionsRecyclerAdapter(list, mListener, getContext()));
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(RecipeInstructionsModel item);
    }
}
