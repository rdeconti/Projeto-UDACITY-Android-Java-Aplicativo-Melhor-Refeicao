...
public class RecipeToolMaintenanceIngredientsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // .............................................................................. Set Layout
        setContentView(R.layout.recipe_tool_maintenance_ingredients_activity);
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(R.string.label_ingredients);
        ...
        final EditText editText_ingredient_name = findViewById(R.id.editText_ingredient_name);
        final EditText editText_ingredient_amount = findViewById(R.id.editText_ingredient_amount);
        final EditText editText_ingredient_unit = findViewById(R.id.editText_ingredient_unit);
        ...
        if (sTypeCRUD.equals(CRUD_TYPE_C)) {
            ...
            editText_ingredient_name.setText(R.string.hint_enter_ingredient_name);
            editText_ingredient_amount.setText(R.string.hint_enter_ingredient_amount);
            editText_ingredient_unit.setText(R.string.hint_enter_ingredient_unit);

        } else {

            editText_ingredient_name.setText(sCurrentRecipeIngredientText);
            editText_ingredient_amount.setText(sCurrentRecipeIngredientAmount);
            editText_ingredient_unit.setText(sCurrentRecipeIngredientUnit);
        ...
        button_change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                @SuppressWarnings("WrapperTypeMayBePrimitive") Boolean sReturnCode;

                sReturnCode = SupportCheckInformationInput.SupportCheckInformationEmpty(editText_ingredient_name, getString(R.string.message_user_information_required));
                if (!sReturnCode) {
                    return;
                }

                sReturnCode = SupportCheckInformationInput.SupportCheckInformationEmpty(editText_ingredient_amount, getString(R.string.message_user_information_required));
                if (!sReturnCode) {
                    return;
                }

                sReturnCode = SupportCheckInformationInput.SupportCheckInformationEmpty(editText_ingredient_unit, getString(R.string.message_user_information_required));
                if (!sReturnCode) {
                    return;
                }
                ...
                String text_name = editText_ingredient_name.getText().toString().trim();
                String text_amount = editText_ingredient_amount.getText().toString().trim();
                String text_unit = editText_ingredient_unit.getText().toString().trim();

                progressBar.setVisibility(View.VISIBLE);

                RecipeDatabaseFirebaseTableIngredients.RecipeIngredientsFirebaseUpdateSingle(
                        text_name,
                        text_amount,
                        text_unit,
                        context);

                RecipeDatabaseSQLiteTableIngredients.RecipeIngredientsSQLiteUpdateSingle(
                        text_name,
                        text_amount,
                        text_unit,
                        context);
        ...
        button_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RecipeDatabaseSQLiteTableIngredients.RecipeIngredientsSQLiteDeleteSingle(getApplicationContext());
                RecipeDatabaseFirebaseTableIngredients.RecipeIngredientsFirebaseDeleteSingle();
        ...
        button_insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RecipeDatabaseFirebaseTableIngredients.RecipeIngredientsFirebaseCreate(
    ...
    private void load_image_on_firebase_storage() {
        ...
        if(filePath != null)
        {
            ...
            storageReference = storageReference.child(PATH_INGREDIENTS_1 + sCurrentRecipePhoto);
    ...
    private static void downloadRecipePhotoInternalStorage(final Context context) {
        ...
        try {
            ...
            firebaseStorage.getReference().child(PATH_INGREDIENTS_1).child(sCurrentRecipeInstructionPhoto + FILE_TYPE).getFile(newFile).
