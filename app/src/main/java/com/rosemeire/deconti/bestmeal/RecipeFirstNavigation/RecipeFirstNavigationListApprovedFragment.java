...
/* ************************************************************************************************/
/* *** Treat Fragment List Recipe: APPROVED
/* ************************************************************************************************/
public class RecipeFirstNavigationListApprovedFragment extends Fragment {
    ...
    /* ********************************************************************************************/
    public RecipeFirstNavigationListApprovedFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_first_navigation_fragment_approved_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeListModelsApproved);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_LIST_APPROVED_TOOLBAR);

        // ........................................... Get data from SQLite and update recycler view
        progressBar.setVisibility(View.VISIBLE);

        List<RecipeHeaderModel> list_approved = RecipeDatabaseSQLiteTableHeader.RecipeHeaderGetListApproved(getContext());

        recyclerView.setAdapter(new RecipeFirstNavigationListApprovedRecyclerAdapter(list_approved, mListener, getContext()));
