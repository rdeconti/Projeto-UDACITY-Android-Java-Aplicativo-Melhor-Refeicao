...
/* ************************************************************************************************/
public class RecipeFirstNavigationListPurchaseFragment extends Fragment {
    ...
    /* ********************************************************************************************/
    public RecipeFirstNavigationListPurchaseFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_first_navigation_fragment_purchase_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipePurchaseModels);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_LIST_PURCHASE_TOOLBAR);

        // ........................................... Get data from SQLite and update recycler view
        progressBar.setVisibility(View.VISIBLE);

        List<RecipePurchaseModel> list_purchase = RecipeDatabaseSQLiteTablePurchase.RecipePurchaseGetList(getContext());

        recyclerView.setAdapter(new RecipeFirstNavigationListPurchaseRecyclerAdapter(list_purchase, mListener, getContext()));
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(RecipePurchaseModel item);
    }
}
