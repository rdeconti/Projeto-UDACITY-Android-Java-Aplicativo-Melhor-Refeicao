...
/* ************************************************************************************************/
/* *** Treat Fragment Detail Recipe: INGREDIENTS
/* ************************************************************************************************/
public class RecipeSecondNavigationIngredientsFragment extends Fragment {
    ...
    private List<RecipeIngredientsModel> list = new ArrayList<>();
    ...
    /* ********************************************************************************************/
    public RecipeSecondNavigationIngredientsFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_second_navigation_fragment_ingredients_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeIngredientsModels);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_DETAIL_INGREDIENTS_TOOLBAR);
        ...
        if (sGetDataFrom.equals(DATA_GET_FROM_FIREBASE)) {
            ...
            list = RecipeDatabaseFirebaseTableIngredients.RecipeListDetailIngredientsGetList();

        } else {

            list = RecipeDatabaseSQLiteTableIngredients.RecipeIngredientsGetList(getContext());

        }

        recyclerView.setAdapter(new RecipeSecondNavigationIngredientsRecyclerAdapter(list, mListener, getContext()));
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(RecipeIngredientsModel item);
    }
}
