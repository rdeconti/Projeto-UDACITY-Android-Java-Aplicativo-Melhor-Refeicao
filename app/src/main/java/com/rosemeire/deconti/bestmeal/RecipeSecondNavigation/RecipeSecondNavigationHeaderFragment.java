...
/* ************************************************************************************************/
/* *** Treat Fragment Detail Recipe: HEADER
/* ************************************************************************************************/
public class RecipeSecondNavigationHeaderFragment extends Fragment {
    ...
    private List<RecipeHeaderModel> list = new ArrayList<>();
    ...
    /* ********************************************************************************************/
    public RecipeSecondNavigationHeaderFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // .............................................................................. Set Layout
        View view = inflater.inflate(R.layout.recipe_second_navigation_fragment_header_list, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recipeHeaderModels);
        ...
        linearLayoutAdMob.setBackgroundColor(INT_COLOR_RECIPE_DETAIL_HEADER_TOOLBAR);
        ...
        if (sGetDataFrom.equals(DATA_GET_FROM_FIREBASE)) {
            ...
            list = RecipeDatabaseFirebaseTableHeader.RecipeHeaderListGetHeader();

        } else {

            list = RecipeDatabaseSQLiteTableHeader.RecipeHeaderGetHeader(getContext());

        }

        recyclerView.setAdapter(new RecipeSecondNavigationHeaderRecyclerAdapter(list, mListener, getContext()));
