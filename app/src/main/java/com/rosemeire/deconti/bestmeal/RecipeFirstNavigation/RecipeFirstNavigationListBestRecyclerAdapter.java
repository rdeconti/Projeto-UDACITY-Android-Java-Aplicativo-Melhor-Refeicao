...
import com.rosemeire.deconti.bestmeal.RecipeFirstNavigation.RecipeFirstNavigationListBestFragment.OnListFragmentInteractionListener;
...
/* *** Treat recycler view
/* ************************************************************************************************/
public class RecipeFirstNavigationListBestRecyclerAdapter extends RecyclerView.Adapter<RecipeFirstNavigationListBestRecyclerAdapter.ViewHolder> {
    ...
    /* ********************************************************************************************/
    RecipeFirstNavigationListBestRecyclerAdapter(List<RecipeHeaderModel> items, OnListFragmentInteractionListener listener, Context context) {
